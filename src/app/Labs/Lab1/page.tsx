  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe (Banana Shake):
        <ol id="wd-your-favorite-recipe">
          <li>Put milk, ice cream and banana into blender.</li>
          <li>Blend everything until it is smooth.</li>
          <li>Put the mixture into a glass</li>
          <li>Add toppings (whipped cream, banana slices, cinnamon etc)</li>
        ...
        <ul id="wd-your-books">
          <li>Harry Potter</li>
          <li>The adventures of Tarzan</li>
          <li>Gandhi</li>
          <li>The Hobbit</li>
          <li>Ikigai</li>
        </ul>
      ...
      to get dummy text
      <br />
      <h5>My Github Kambaz Project</h5>
      Please
      <a href="https://github.com/Adnu100/kambaz-next-js" id="wd-github">
        click here
      </a>
      to go to my Github Kambaz project source
    </div>
  );
}
